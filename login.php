...
if(isset($_POST['submit'])) {
 ...
 header('Location: cabinet.php '.$ref);
 exit();
	}
...
?>
	...
	<h1 align="center"><strong>Авторизация пользователя</h1></strong>
	<br></br>
		<div class="row">
	...
	<p class="to_reg">Если вы не зарегистрированы в системе, <a href="registration.php">зарегистрируйтесь</a>.</p><br></br><br></br></br>
